    ...
    return (
        <section className="bg-gradient-to-br from-[#0b122d] to-[#0b163d] text-white py-24 px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                ...
                <Button text='Talk to Experts' className="border border-white hover:bg-white hover:text-[#0b122d] text-white font-semibold px-6 py-3 rounded-md transition" />
            </div>
        </section>
    );
};

...
const ApiIntegrationComponent = () => {
    ...
    return (
        <section className='max-w-[1200px] mx-auto p-4 my-10' >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10 p-4 ' >
                <div class="flex flex-col gap-4">
                    <div className='text-[#a5f3fc] bg-[#0f172a] p-4'>
                    ...
                    <Button text='View API Docs' className=' text-white bg-blue-600' />
                </div>
                <div className='p-2'>
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 ">
                        {features.map((feature, index) => (
                            <li key={index} className='bg-white p-5 rounded-lg hover:shadow-lg hover:scale-105 duration-500' >
                                <h3>{feature.title}</h3>

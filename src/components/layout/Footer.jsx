        ...
        <section className='w-full z-50 '>
            <footer className='bg-[#000000] text-white'>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 p-8 max-w-[1400px] mx-auto">
                    ...
                    <div className='border-t-1 md:border-t-0 py-4 md:border-l border-[#777676] pl-4'>
                        <ul>
                            <h2 className='text-lg font-semibold mb-2'>Products</h2>
                            <li className='text-sm text-[#CDCDCD] mb-1'>Payment Gateway</li>
                            <li className='text-sm text-[#CDCDCD] mb-1'>Payouts</li>
